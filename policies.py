...
class PolicyWithValue(object):
    ...
    def __init__(self, env, observations, latent, estimate_q=False, observation_dependent_var=False, vf_latent=None, sess=None, **tensors):
        """
        Parameters:
        ----------
        env             RL environment
...
def build_policy(env, policy_network, value_network=None, normalize_observations=False, estimate_q=False,
                 observation_dependent_var=False, **policy_kwargs):
    ...
    def policy_fn(nbatch=None, nsteps=None, sess=None, observ_placeholder=None):
        ...
        policy = PolicyWithValue(
            ...
            observation_dependent_var=observation_dependent_var,
            **extra_tensors
        )
        return policy
